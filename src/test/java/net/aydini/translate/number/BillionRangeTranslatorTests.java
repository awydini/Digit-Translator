...
public class BillionRangeTranslatorTests
{
    ...
    public static class NumberArgumentProvider implements ArgumentsProvider
    {
        ...
        {
            map.put(-1000000001l, "منفی یک ملیارد و یک");
            map.put(999555111222l, "نهصد و نود و نه ملیارد و پانصد و پنجاه و پنج میلیون و صد و یازده هزار و دویست و بیست و دو");
            map.put(3000000000000l, "سه هزار ملیارد");
            map.put(300000000000000l, "سیصد هزار ملیارد");
            return map;
        }
